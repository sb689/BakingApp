...
public class RecipeDetailActivityBasicTest {
    ...
    private static final String KEY = "bundle_extra_recipe_obj";
    ...
    @Test
    public void clickIngredients_displaysIngredientsDetail(){
        onView(withId(R.id.tv_ingredients_title)).perform(click());
        onView(withId(R.id.rv_ingredient_detail)).check(matches(isDisplayed()));

    }

    @Test
    public void clickStep_displaysStepDetail(){
        onView(withId(R.id.rv_ingredient_steps)).perform(RecyclerViewActions.actionOnItemAtPosition(0,click()));
